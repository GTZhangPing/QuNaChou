...
#define  COLOR_PINK [UIColor colorWithRed:255.0/255.0f green:206.0/255.0f blue:200.0/255.0f alpha:1.0]
#define  COLOR_RED [UIColor colorWithRed:250.0/255.0f green:72.0/255.0f blue:48.0/255.0f alpha:1.0]
...
- (void)defaultInit {
    ...
    self.barStartAngle = 180;
    self.barLength = 180;
    self.type = CircularProgressBarTypeCircular;
    self.progress = 0;
    self.greyProgressColor = COLOR_PINK;
    self.progressTintColor = COLOR_RED;
    self.designsMargin = 2.0;
    self.BarRedius = self.frame.size.width/3;
    self.BarCenter = CGPointMake(self.frame.size.width/2, self.frame.size.height/2);
    self.clockwise = YES;
    self.rectWidth = 2;
    self.rectHieght = 20;
    self.circularRedius = 9.0;
    self.angleDifference = 9.5;
