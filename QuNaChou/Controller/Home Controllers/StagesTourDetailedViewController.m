//
//  StagesTourDetailedViewController.m
//  QuNaChou
//
...
@interface StagesTourDetailedViewController ()<GYZChooseCityDelegate,ChooseDateViewControllerDelegate,ReminderLoginViewDelegate>
...
@implementation StagesTourDetailedViewController
...
- (void)viewDidLoad {
    ...
    [self initRemindBound];  //初始化提醒绑卡界面
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    //出发地点
    if (_city) {
        _StartPlaceLab.text = [NSString stringWithFormat:@"%@（点击修改）",_city];
    }
...
- (IBAction)ButtonClicked:(UIButton *)button {
    ...
    if (button.tag == 2211) {
        ...
        [_ConfirmButton setTitle:@"理财20000元 共三期免单                  确定" forState:UIControlStateNormal];
        _type = @"15";
        _money = @"20000";
    ...
    if (button.tag == 2212) {
        ...
        [_ConfirmButton setTitle:@"理财25000元 共六期免单                  确定" forState:UIControlStateNormal];
        _type = @"16";
        _money = @"25000";
    ...
    if (button.tag == 2213) {
        ...
        _type = @"17";
        [_ConfirmButton setTitle:@"理财30000元 共九期免单                  确定" forState:UIControlStateNormal];
        _money = @"30000";
    ...
    if (button.tag == 2214) {
        ...
        _type = @"18";
        [_ConfirmButton setTitle:@"理财35000元 共十二期免单                  确定" forState:UIControlStateNormal];
        _money = @"35000";
    ...
    if (button.tag == 2215) {
        ...
        _type = @"19";
        [_ConfirmButton setTitle:@"理财40000元 共二十四期免单                  确定" forState:UIControlStateNormal];
        _money = @"40000";
    }
}
