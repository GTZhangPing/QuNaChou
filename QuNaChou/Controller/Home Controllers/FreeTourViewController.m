...
@interface FreeTourViewController ()<UISearchBarDelegate,UIScrollViewDelegate,FreeTourTableViewCellDelegate>
...
@implementation FreeTourViewController
...
- (void)viewDidLoad {
    ...
    NSArray *array1 = @[@"MDbg2",@"塞班岛",@"miandan_",@"理财20000元起",@"1000元",@"shoucang_"];
    NSArray *array2 = @[@"MDbg2",@"塞班岛",@"miandan_",@"理财20000元起",@"1000元",@"shoucang_"];
    NSArray *array3 = @[@"MDbg2",@"塞班岛",@"miandan_",@"理财20000元起",@"10000元",@"shoucang_"];
...
{
    static NSString *cellIdentifier = @"FreeTourCell";//定义一个可重用标识
    FreeTourTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];//从重用队列里获取可重用的cell
    if (!cell)
    {
        //如果不存在，创建一个可重用cell
        cell = [[FreeTourTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault
...
{
    FreeTourDetailedViewController *VC = [self.storyboard instantiateViewControllerWithIdentifier:@"FreeTourDetailedViewController"];
